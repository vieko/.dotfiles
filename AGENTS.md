...
Canonical guidance for any coding agent (Claude Code, Pi, Codex, …) working in
this repository. `CLAUDE.md` is a symlink to this file, so both filenames
resolve to identical content — edit only `AGENTS.md`.
