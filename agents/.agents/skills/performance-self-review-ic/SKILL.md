...
- **Previous review:** Vieko keeps downloaded Culture Amp history locally. Look under
  `~/private/` (e.g. `~/private/reviews/`); if not found, ask for its location rather than
  skipping the prior-review pass.
